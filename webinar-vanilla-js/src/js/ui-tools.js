 ...
 * @param {String} toastType Type of toast: success, danger, warning, info
 * @param {Number} duration Time in milliseconds to display the toast
 */
...
/************************/
/**
 * Adds a modal dialog to the DOM
 * @param {String} title Modal title
 * @param {String} message Modal message
 * @param {Boolean} closeButton Show close button in modal
...
/**
 * Shows a modal for "seconds" seconds
 * @param {Number} seconds Time in seconds to show the modal
 * @returns Promise
 */
...
/**
 * Add profile dropdown to the DOM
 */
export const addProfileDropdown = (username, logout) => {
